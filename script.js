...
const translations = {
  zh: {
    title: 'Andrew Liu — Builder of AI Tools',
    description: 'Andrew Liu 的个人作品集：AI 产品、系统工程与技术写作。',
    skip: '跳到主要内容',
    navLabel: '主导航',
    nav: ['项目', '博客', '关于', '联系'],
    languageLabel: '选择语言',
    homeLabel: 'Andrew Liu 首页',
    heroEyebrow: 'Backend engineer · AI builder',
    heroTitle: ['把想法做成', '能用的产品。'],
    heroIntro: '我是 Andrew，一名后端工程师。用 C++、Go 和 Python 构建系统，也把 AI Agent、信息聚合与开发者工具做成真正可用的产品。',
    viewWork: '查看作品',
  ...
  en: {
    title: 'Andrew Liu — Builder of AI Tools',
    description: 'Andrew Liu’s portfolio: AI products, systems engineering, and technical writing.',
    skip: 'Skip to main content',
    navLabel: 'Primary navigation',
    nav: ['Work', 'Blog', 'About', 'Contact'],
    languageLabel: 'Choose language',
    homeLabel: 'Andrew Liu home',
    heroEyebrow: 'Backend engineer · AI builder',
    heroTitle: ['Turning ideas into', 'products people use.'],
    heroIntro: 'I’m Andrew, a backend engineer building systems with C++, Go, and Python—and turning AI agents, information intelligence, and developer tools into useful products.',
